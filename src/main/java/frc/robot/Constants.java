...
//controller 0
 ...
 public final class Constants {
    ...
    public static final double SHOOTER_MOTOR_TARGET_MAX = 1.005;
    public static final double SLOW_SHOOTER_SPEED = 1462;
    public static final double SHOOTER_SPEED = 1485;
    public static final double FAST_SHOOTER_SPEED = 1700;
    
    public static final double SHOOTER_kP = .0009; 
    public static final double SHOOTER_kI = 0;
    public static final double SHOOTER_kD = 0.00045; 
