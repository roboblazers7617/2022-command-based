...
public class ShuffleboardInfo {
    ...
    private final NetworkTableEntry intakeRotationMotorPosition, intakeRotationMotorSpeed;
    ...
    private ShuffleboardInfo() {
        ...
        intakeRotationMotorSpeed = intakeLayout.add("Intake motor speed", 0.0).getEntry();
    }
