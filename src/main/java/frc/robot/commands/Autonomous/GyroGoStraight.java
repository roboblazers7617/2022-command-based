...
public class GyroGoStraight extends CommandBase {
  ...
  public GyroGoStraight(Drivetrain drivetrain, String direction, double distance) {
    ...
    // Use addRequirements() here to declare subsystem dependencies.
      ...
      m_distance = Units.inchesToMeters(distance);
      addRequirements(drivetrain);
      m_gyroAdjustment = m_drivetrain.getAngle();
      m_positionAdjustment = m_drivetrain.getEncoderDistance();
      m_angleController.setSetpoint(m_gyroAdjustment);
  ...
  public void execute() {
    ...
    speed = (m_positionController.calculate(m_drivetrain.getEncoderDistance()));
    if(!finished){
